...
- [`knndm()`](https://janlinnenbrink.github.io/PDAV/reference/knndm.md)
  : K-fold Nearest Neighbour Distance Matching
- [`log_message()`](https://janlinnenbrink.github.io/PDAV/reference/log_message.md)
  : Conditional logging with verbosity levels
- [`make_twcv_specs()`](https://janlinnenbrink.github.io/PDAV/reference/make_twcv_specs.md)
